      ...
      <div class="row ">
         <div class="col-lg-8 detail-new ">
            <div class="card ">
               <a href="#"><img style="max-height: 350px; object-fit: cover; object-position: center top"
                     class="card-img-top" src="{{ asset('storage/images/blog/' . $blog->image) }}" alt=""></a>
               <div class="card-body ">
            ...
            <div class="row container card-width readTooContainer  " data-category-name="{{ $readTooDiv->content }}">
         ...
         <div class="col-lg-4 related-side pt-sm-5 p-lg-0  ">
            ...
            <div class="side-two py-5 ">
               ...
               <div class="news-more d-flex align-items-center px-4 py-4 border ">
                  <img src="{{ asset('storage/images/blog/' . $blog_most_view->image) }}"
                     style="max-height: 70px; object-fit: cover; object-position: center top" alt="">
                  <span class="mr-3">
                     @php
                     $slug = Str::slug($blog_most_view->name);
                     @endphp
                     <a href="{{ route('post_details', ['id' => $blog_most_view->id, 'slug' => $slug]) }}">
                        {{ $blog_most_view->name }}
                     </a>
                  </span>
               </div>
            ...
            <div class="side-three pb-5 ">
               ...
               <div class="d-grid flex-column main-news-container" data-category-name="{{ $mainNewsDiv->content }}">
