    ...
    <main class="container text-right py-5">
        <div class="row ">
            <div class="col-lg-8 detail-new ">
                <div class="card ">
                    <a href="#"><img class="card-img-top" src="{{ asset('front/assets/images/mainnew.png') }}"
                            alt=""></a>
                    <div class="card-body ">
                ...
                <div class="my-5 pt-5 pl-5 d-flex align-items-center justify-content-between  border-bottom ">
                    <p class="comments">التعليقات : <span class="comments-number">0</span></p>
                    <div class="filter-comments ">
                        <form action="/action_page.php">
                            <label class="comments" for="cars">اختر حسب:</label>
                ...
                <div class="container-2-col-commits  ">
                    <div class=" ">
