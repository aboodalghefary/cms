...
<body dir="">
    ...
    <main  class="main d-flex flex-column justify-content-center cont box " style="min-height: 70vh;">
        <div class="gallery">
            <a class="card" href="../assets/images/1.jpg">
                <img src="../assets/images/1.jpg" alt="">
            </a>
            <a class="card" href="../assets/images/2.jpg">
