...
<body dir="">
                ...
                <div class="collapse  navbar-collapse" id="navbarSupportedContent">
                    <ul class=" navbar-nav mr-auto mb-2 ml3 mb-lg-0">
                        <li class="nav-item active-item">
                            <a class="nav-link active " aria-current="page" href="{{ asset('pages/index.html') }}">الرئيسية</a>
                        </li>
                        <li class="nav-item ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ asset('pages/video-library.html') }}">فيديو </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ asset('pages/contact.html') }}">اتصل بنا</a>
                        </li>
    ...
    <ol class="breadcrumb" dir="rtl">
        <div class="bread container d-flex">
            ...
            <li class="breadcrumb-item ">
                <a href="index.html"> صور سيارات</a>
            </li>
        </div>
    </ol>
    ...
    <main class="cont">
        <div class="gallery">
            <a href="{{ asset('assets/images/1.jpg') }}">
                <img src="{{ asset('assets/images/1.jpg') }}" alt="">
            </a>
            <a href="{{ asset('assets/images/2.jpg') }}">
