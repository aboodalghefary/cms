    ...
    <main class="py-3" dir="rtl">
        <div class="container home-intro">
            ...
            <div class="advertise-space adv-2-columns py-5  ">
                ...
                <a class=" bg-light py-5"> <img src="{{ asset('storage/images/div/' . $ad1Div->image) }}"> </a>

                <a class=" bg-light py-5"> <img src="{{ asset('storage/images/div/' . $ad2Div->image) }}"
                        alt=""> </a>
            ...
            <div class="template-one ">
                ...
                <div class="advertise-space adv-2-columns py-5  ">
                    ...
                    <a class=" bg-light py-5"> <img src="{{ asset('storage/images/div/' . $ad3Div->image) }}"
                            alt=""> </a>

                    <a class=" bg-light py-5"> <img src="{{ asset('storage/images/div/' . $ad4Div->image) }}"
                            alt=""> </a>
                ...
                <div class="advertise-space adv-2-columns py-5  ">
                    ...
                    <a class=" bg-light py-5"> <img src="{{ asset('storage/images/div/' . $ad5Div->image) }}"
                            alt=""> </a>

                    <a class=" bg-light py-5"> <img src="{{ asset('storage/images/div/' . $ad6Div->image) }}"
                            alt=""> </a>
            ...
            <div class="container pt-5">
                ...
                <div class="advertise-space adv-2-columns py-5  ">
                    ...
                    <a class=" bg-light py-5"> <img src="{{ asset('storage/images/div/' . $ad7Div->image) }}"
                            alt=""> </a>

                    <a class=" bg-light py-5"> <img src="{{ asset('storage/images/div/' . $ad8Div->image) }}"
                            alt=""> </a>
