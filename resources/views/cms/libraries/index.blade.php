...
@section('tittle_1', ' عرض مكتبات الفيديو ')
@section('tittle_2', ' عرض مكتبات الفيديو ')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">قائمة مكتبات الفيديو</h5>
        </div>
                ...
                @foreach ($libraries as $library)
                    <tr>
                        ...
                        <td><a href="{{ route('videos_create', $library->id) }}" class="btn text-nowrap btn-outline-indigo">
                                اضافة
                                فيديو </a></td>
                        <td><a href="{{ route('videos_index', $library->id) }}" class="btn text-nowrap btn-outline-indigo">
                                عرض
                                الفيديوهات
                        <td class="div-center">
                            <div class="d-inline-flex">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="{{ route('libraries.edit', $library->id) }}" class="dropdown-item">
                                            <i class="ph-note-pencil me-2"></i>
                                            تعديل
                                        </a>
                                        <a href="#" onclick="performDestroy({{ $library->id }},this)"
                                            class="dropdown-item">
