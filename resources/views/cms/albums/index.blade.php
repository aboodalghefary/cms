@extends('cms.master')
@section('title', 'الابومات')

@section('tittle_1', ' عرض الابومات ')
@section('tittle_2', ' عرض الابومات ')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">قائمة الابومات</h5>
        </div>
                ...
                @foreach ($albums as $album)
                    <tr>
                        ...
                        <td><a href="{{ route('photos_create', $album->id) }}" class="btn text-nowrap btn-outline-indigo">
                                اضافة
                                صورة </a></td>
                        <td><a href="{{ route('photos_index', $album->id) }}" class="btn text-nowrap btn-outline-indigo">
                                عرض
                                الصور
                            </a></td>
                        <td class="div-center">
                            <div class="d-inline-flex">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="#" onclick="performDestroy({{ $album->id }},this)"
                                            class="dropdown-item">
