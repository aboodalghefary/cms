...
<body>
         ...
         <div class="container-fluid">
            ...
            <div class="row mt-5 pt-5">
               <div class="buttons d-flex justify-content-between flex-wrap">
                  <a href="{{ route('createFormBreakingNew') }}" class="btn text-bg-indigo px-md-5 "> <i
                        class="ph-lightning mx-1"></i> الاخبار
                     العاجلة
                  </a>
                  <a href="{{ route('blogs.create') }}" class="btn text-bg-danger px-md-5 "> <i
                        class="ph-article mx-1"></i> مقال
                  </a>
                  <a href="{{ route('albums.index') }}" class="btn text-bg-warning px-md-5 "> <i
                        class="ph-file-image mx-1"></i>البومات الصور
                  </a>
                  <a href="{{ route('libraries.index') }}" class="btn text-bg-teal px-md-5 "> <i
                        class="ph-file-video mx-1"></i>مكتبات الفيديو
                  </a>
                  <a href="{{ route('categories.index') }}" class="btn text-bg-dark px-md-5 "><i
                        class="ph-tag mx-1"></i> الاصناف
                  </a>
                  <a href="{{ route('authors.index') }}" class="btn text-bg-success px-md-5 "><i
                        class="ph-user-circle-gear mx-1"></i> الاعضاء
                  </a>
                  <a href="{{ route('front_control') }}" class="btn text-bg-purple px-md-5"><i class="ph-gear mx-1"></i>
                     الاعدادات
                  </a>
               </div>
            </div>
   ...
   <!-- /page content -->
   <div class="modal fade" id="files_library" tabindex="-1" aria-labelledby="files_libraryLabel" aria-hidden="true">
               ...
               <div class="d-lg-flex align-items-lg-start">
                           ...
                           <div class="collapse show" id="sidebar-search" style="">
                              <div class="sidebar-section-body">
                                 <div class="form-control-feedback form-control-feedback-end">
                                    <input type="search" class="form-control searchForFile" placeholder="Search">
                  ...
                  <div class="flex-1">
                     ...
                     <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <div id="progress-bar-container" style="width: 100%; background-color: #f1f1f1;">
                              <div id="progress-bar" class="my-5 text-center" style="height: 0px;
                     ...
                     <div class="card overview">
                        ...
                        <div class="card-body d-flex justify-content-center p-3 flex-wrap gap-1" data-type="all">
                        </div>
                     </div>
