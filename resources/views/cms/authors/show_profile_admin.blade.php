    ...
    <div class="profile-cover">
        ...
        <div
            ...
            <div class="profile-cover-text text-white">
                <h1 class="mb-0">{{ ucwords($admin->user->name) }}</h1>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" id="name"
                                                value="{{ $admin->user->name }}" class="form-control" placeholder=" الاسم ">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="address" id="address" class="form-control"
                                                placeholder="العنوان" value="{{ $admin->user->address }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="city" id="city" class="form-control"
                                                placeholder="المدينة" value="{{ $admin->user->city }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select data-placeholder="الحالة" name="status" id="status"
                                                ...
                                                <option value="married" data-icon="heart"
                                                    {{ $admin->user->status == 'married ' ? 'selected' : null }}>متزوج
                                                </option>
                                                <option value="single" data-icon="heart-break"
                                                    {{ $admin->user->status == 'single ' ? 'selected' : null }}>اعزب
                                                </option>
                                                <option value="separated" data-icon="heartbeat"
                                                    {{ $admin->user->status == 'separated ' ? 'selected' : null }}>مطلق
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select data-placeholder="الجنس" name="gender" id="gender"
                                                ...
                                                <option value="male" data-icon="gender-male"
                                                    {{ $admin->user->gender == 'male ' ? 'selected' : null }}>
                                                    ذكر</option>
                                                <option value="female"
                                                    {{ $admin->user->gender == 'female ' ? 'selected' : null }}>انثى
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-select select" id="role_id" name="role_id">
                                                @foreach ($roles as $role)
                                                    <option value="{{ $role->id }}"
                                                        {{ $admin->role_id == $role->id ? selected : null }}>
                                                        {{ $role->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="#">
                                ...
                                <div class="text-end">
                                    <button type="button" onclick="performUpdatePassword({{ $admin->id }})"
...
@section('scripts')
    ...
    <script>
        function performUpdate(id) {
            ...
            storeRedirect('/cms/admin/admins_update/' + id, formData, '/cms/admin/authors/');
        }
        ...
        function performUpdatePassword(id) {
            ...
            storeRedirect('/cms/admin/admins_update_password/' + id, formData, '/cms/admin/authors/');
        }
    </script>
@endsection
