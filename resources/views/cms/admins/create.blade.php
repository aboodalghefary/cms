                ...
                <div class="card-body">
                    <form action="#">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9">
                                <select data-placeholder="الحالة" name="status" id="status" class="form-select select">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9">
                                <select data-placeholder="الجنس" name="gender" id="gender" class="form-select select">
