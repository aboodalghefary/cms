...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0"> تعديل مشرف </h6>
        </div>
        <div class="card-body">
            <form action="#">
                <div class="mb-3">
                    <label class="form-label">الاسم</label>
                    <input type="text" name="name" id="name" value="{{ $admin->user->name }}" class="form-control"
                        placeholder=" الاسم ">
                </div>
                <div class="mb-3">
                    ...
                    <div class="form-control-feedback form-control-feedback-start">
                        <input type="text" class="form-control" name="email" id="email" value="{{ $admin->email }}"
                            disabled placeholder="john@doe.com">
                            ...
                            <select class="form-select select" id="role_id" name="role_id">
                                @foreach ($roles as $role)
                                    <option value="{{ $role->id }}"
                                        {{ $admin->role_id == $role->id ? selected : null }}>{{ $role->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
