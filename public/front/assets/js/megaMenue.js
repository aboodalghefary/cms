function displayNewsItems(posts) {
   ...
   posts.forEach((post) => {
      const formattedDate = new Date(post.updated_at).toLocaleDateString(
         "en-US"
      );
...
// $(".nav-link.parent_category").on("mouseenter", function (event) {
//    const category = $(this).data("category");
//    const listItems = $(".mega-menue .four-category-news");
